...
import com.example.ilcarro.data.dto.car.ui.addCarUI.AddCarUICarDetailsFirstChunk
...
class LetTheCarWorkCarDetailsFirstViewModel @Inject constructor(
    ...
    var mCarInfoFirstChunk = Mapper.toAddCarUICarDetailsFirstChunk(mCarStorageUseCases.getAddCarUI())
